...
static bool g_bResetScriptVMOnLoad;
...
void List_LoadGamedata(GameData hGameData)
{
	...
	char sVal[12];
	hGameData.GetKeyValue("ResetScriptVMOnLoad", sVal, sizeof(sVal));
	g_bResetScriptVMOnLoad = !!StringToInt(sVal);
}
